...
public class SelectListExam {
    public static void main(String[] args){
        ...
        final String driverURL = "jdbc:mysql://localhost:3306/freeboard?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC"; // driver URL형식 Database마다 다르다.
        final String dbUserId = "boardadmin";
        final String dbUserPassword = "admin";
        ...
        try {
            ...
            while(rs.next()){
                ...
                System.out.println(id + "," + title + ", " + name + ", " + content + ", " + regdate + ", " + readcount + ", " + family + ", " + level + ", " + sequence);
            }
